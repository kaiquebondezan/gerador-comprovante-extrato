...
// Substitui cada "{{CHAVE}}" do template pelo valor correspondente.
...
// Monta o HTML final do comprovante a partir do template + dados do request.
// banco_nome/brand_color/data_pagamento/horario/id_transacao nunca vêm do
// body: são sempre fixos ou calculados no momento da requisição.
...
// Monta o HTML do extrato a partir da conta (lida do JSON fictício) + das
// movimentações já filtradas pelo período pedido, e dos totais já calculados.
